...
from ..encoder_volsplat import EncoderVolSplat
# from ..epipolar.epipolar_sampler import EpipolarSampling
from .encoder_visualizer import EncoderVisualizer
from .encoder_visualizer_depthsplat_cfg import EncoderVisualizerVolSplatCfg
...
class EncoderVisualizerVolSplat(
    EncoderVisualizer[EncoderVisualizerVolSplatCfg, EncoderVolSplat]
):
    def visualize(
        self,
