...
class DatasetScannet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # ViewSamplerEvaluation only returns 2 values, other view_samplers may return 2 or 3 values
        ...
        # Handle cases where 2 or 3 values are returned
        if len(sample_result) == 2:
            context_index, target_indices = sample_result
            fvs_length = None  # This value is not needed in evaluation mode
        else:
            context_index, target_indices, fvs_length = sample_result
